...
<body>
<div class="card HideThisElement" id="ClientViewDiv">
    <div class="card-body">
    	<div class="row">
    		<div class="col-md-6"><h5 class="card-title">Client Details</h5></div>
    	...
    	<dl class="row">
		  ...
		  <dt class="col-sm-2">Customer Type</dt>
		  <dd class="col-sm-2" id="customerTypeText"></dd>
