    ...
    <div class="card-body">
        ...
        <ul class="nav nav-tabs" id="myTab" role="tablist">
	        ...
	        <div class="tab-content" id="myTabContent">
	            <div class="tab-pane fade show active" id="ClientDetails" role="tabpanel" aria-labelledby="ClientDetails-tab">
	            	<form action="" id="newElementForm" name="newElementForm">
	            	 <input type="hidden" name="action" id="action">
	            	    <input type="hidden" name="rowId" id="selectedClientId">
	                <div class="form-row">
	                ...
	                <div class="form-row">
	                    ...
	                    <div class="form-group col-md-4 HideThisElement" id="referenceDiv">
	                        ...
	                        <input type="text" class="form-control validate" id="reference" name="referenceBy" placeholder="Reference By">
	                    </div>
	                </div>
	                </form>
	            </div>
	            ...
	            <form action="" id="insertAddressDetails" name="insertAddressDetails">
	            	 <input type="hidden" name="action" id="action">
	             <input type="hidden" name="rowId" id="selectedClientAddressId">
		             <div class="form-row">
	            ...
	            <div class="tab-pane fade" id="ContactPersonDetails" role="tabpanel" aria-labelledby="ContactPersonDetails-tab">
	                <form action="" id="insertContactPersonDetailsDetails" name="insertContactPersonDetailsDetails">
	                 <input type="hidden" name="rowId" id="selectedClientContactPersonId">
	                 	 <input type="hidden" name="action" id="action">
	                <div class="form-row">
	                    <div class="form-group col-md-4">
	                ...
	                <div class="form-row">
	                	...
	                	<div class="form-group col-md-3">
	                        <label id="birthDateLbl" for="birthDate">BirthDate </label>
	        ...
	        <div class="left">
		        <button type="button" class="btn btn-primary HideThisElement" id="SubmitButtonRegister">Submit</button>
		         <button type="button" class="btn btn-primary HideThisElement" id="SubmitButtonContactPerson">Submit</button>
		          <button type="button" class="btn btn-primary HideThisElement" id="SubmitButtonAddressDetails">Submit</button>
		        <button type="button" class="btn btn-primary HideThisElement" id="SubmitButtonUpdate">Update</button>
		          <button type="button" class="btn btn-primary HideThisElement" id="SubmitButtonUpdateContactPerson">Update</button>
		           <button type="button" class="btn btn-primary HideThisElement" id="SubmitButtonUpdateAddress">Update</button>
