	...
	<div class="container">
		<div class="container-fluid">
       		<input type="hidden" id="for" name="for" value="<%= request.getParameter("for") %>">
       	     ...
       	     <jsp:include page="/WEB-INF/JSPs/SampleTransfer/SampleTransfer.jsp"/>
			<%-- <%@include file="DeleteClient.jsp"%> --%>
		</div>
	</div>
	<jsp:include page="/WEB-INF/JSPs/Footer.jsp"/>
</body>
<script src="<c:url value="/resources/js/SampleTransfer/SampleTransfer1.js" />"></script>
  ...
  <script src="<c:url value="/resources/js/SampleTransfer/ShowTransferProductList.js" />"></script>
