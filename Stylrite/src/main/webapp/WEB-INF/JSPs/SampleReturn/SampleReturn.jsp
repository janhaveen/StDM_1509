...
<body>
	...
	<div class="container">
		<div class="container-fluid">
			<div class="card" id="SampleReturnFormDiv">
			  <div class="card" >
   			  ...
   			  <div class="card">
   				 <div class="card-body" style="padding-bottom: 0px;">
   				     <jsp:include page="/WEB-INF/JSPs/SampleReturn/SampleReturnProductList.jsp"/>
   				 	<br>
   				 	<!-- <button type="button" id="BackProduct" class="btn btn-sm btn-outline-primary">Back</button> -->
					<button type="button" id="submitReturn" class="btn btn-sm btn-primary">Return</button>
   				 </div>
   			  </div>
   			  </div>
