...
function getCotactPerson()
{
	...
	$('#contactPersonDatatables tbody').on('click', '.edit_me', function() 
		...
		$("#ClientFormDiv #SubmitButtonUpdateContactPerson").removeClass("HideThisElement");
    ...
    $('#contactPersonDatatables tbody').on( 'click', 'td', function () {
...
function loadBlankformCP() 
{
	...
	$("#ClientFormDiv #SubmitButtonContactPerson").removeClass("HideThisElement");
	
	$("#ClientFormDiv #SubmitButtonUpdateContactPerson").addClass("HideThisElement");
	$("#ClientFormDiv #SubmitButtonAddressDetails").addClass("HideThisElement");
	$("#ClientFormDiv #SubmitButtonRegister").addClass("HideThisElement");
