...
@Entity
@Table(name="d_inventory_legend")
@DynamicUpdate
@JsonIgnoreProperties({"hibernateLazyInitializer", "handler"})
@XmlAccessorType(XmlAccessType.FIELD)
@XmlRootElement(name = "InventoryLegend")
@Proxy(lazy = false)
public class InventoryLegend 
{
	...
	{
		return "InventoryLegend [rowNo=" + rowNo + ", rowId=" + rowId + ", legendGroup=" + legendGroup + ", category="
