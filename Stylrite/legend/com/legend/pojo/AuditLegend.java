...
@Entity
@Table(name="d_audit_legend")
@DynamicUpdate
@JsonIgnoreProperties({"hibernateLazyInitializer", "handler"})
@XmlAccessorType(XmlAccessType.FIELD)
@XmlRootElement(name = "AuditLegend")
@Proxy(lazy = false)
public class AuditLegend implements Serializable 
{
		@Id
		...
		public String toString() {
			return "AuditLegend [rowNo=" + rowNo + ", rowId=" + rowId + ", legendGroup=" + legendGroup + ", category="
