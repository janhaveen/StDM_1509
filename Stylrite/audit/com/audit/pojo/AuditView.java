...
public class AuditView implements Serializable 
{
		...
		@Column(name="sectiionCount")
		private String sectiionCount;
		...
		public String getSectiionCount() {
			return sectiionCount;
		}

		public void setSectiionCount(String sectiionCount) {
			this.sectiionCount = sectiionCount;
		}

		@Override
		public String toString() {
			return "AuditView [rowNo=" + rowNo + ", rowId=" + rowId + ", auditReason=" + auditReason
					...
					+ ", updatedBy=" + updatedBy + ", updatedOn=" + updatedOn + ", sectiionCount=" + sectiionCount
					+ "]";
		}
}
