...
@Entity
@Table(name="auditDetailsView")
@DynamicUpdate
@JsonIgnoreProperties({"hibernateLazyInitializer", "handler"})
@XmlAccessorType(XmlAccessType.FIELD)
@XmlRootElement(name = "AuditDetailsView")
@Proxy(lazy = false)
public class AuditDetailsView implements Serializable 
{
		@Id
		...
		public String toString() {
			return "AuditDetailsView [rowNo=" + rowNo + ", rowId=" + rowId + ", auditReason=" + auditReason
