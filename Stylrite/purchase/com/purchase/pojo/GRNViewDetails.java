...
@XmlRootElement(name ="GRNViewDetails")
@Proxy(lazy = false)
public class GRNViewDetails implements Serializable
{
	...
	public String toString() {
		return "GRNViewDetails [rowNo=" + rowNo + ", rowId=" + rowId + ", GRNId=" + GRNId + ", status=" + status
